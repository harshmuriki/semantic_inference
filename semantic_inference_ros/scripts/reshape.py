...
import time
import numpy as np
from camera_compressed import ImageDecompressor
...
def semantic_image_callback(msg):
    ...
    try:
        ...
        resized_msg_semantic = bridge.cv2_to_imgmsg(uint16_image, "16UC1")
...
def image_resizer():
    ...
    rospy.Subscriber('/camera/color/image_raw/semantic_uncompressed', Image, image_callback)
